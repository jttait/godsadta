...
func TestShouldAppendMultipleItemsToArrayList(t *testing.T) {
	...
	l = l.Append(6)
	l = l.Append(7)
	want := NewArrayImmutableList[int](5, 6, 7)
	result := l.Equal(want)
...
func TestShouldPrependMultipleItemsToArrayList(t *testing.T) {
	...
	l = l.Prepend(6)
	l = l.Prepend(7)
	want := NewArrayImmutableList[int](7, 6, 5)
	result := l.Equal(want)
	assert.AssertTrue(result, t)
}
...
func TestShouldRemoveItemAtIndex(t *testing.T) {
	l := NewArrayImmutableList[int](1, 2, 3)
	l, _ = l.Remove(1)
	want := NewArrayImmutableList[int](1, 3)
	result := l.Equal(want)
	assert.AssertTrue(result, t)
}
...
func TestShouldInsertItemAtIndex(t *testing.T) {
	l := NewArrayImmutableList[int](1)
	l, _ = l.Insert(0, 2)
	l, _ = l.Insert(1, 3)
	want := NewArrayImmutableList[int](2, 3, 1)
	result := l.Equal(want)
	assert.AssertTrue(result, t)
}
...
func TestShouldApplyMapToArrayList(t *testing.T) {
	...
	want := NewArrayImmutableList[int](2, 4, 6)
	result := l.Equal(want)
	assert.AssertTrue(result, t)
}

func TestShouldApplyFilterToArrayList(t *testing.T) {
	l := NewArrayImmutableList[int](1, 2, 3, 4)
	l = l.Filter(func(i int) bool { return i%2 == 0 })
	want := NewArrayImmutableList[int](2, 4)
	result := l.Equal(want)
	assert.AssertTrue(result, t)
}

func TestShouldBeTrueForIdenticalImmutableArrayLists(t *testing.T) {
	a := NewArrayImmutableList[int](1, 2, 3, 4)
	b := NewArrayImmutableList[int](1, 2, 3, 4)
	result := a.Equal(b)
	assert.AssertTrue(result, t)
}
...
func TestShouldBeFalseForDifferentImmutableArrayLists(t *testing.T) {
	a := NewArrayImmutableList[int](1, 2, 3, 4)
	b := NewArrayImmutableList[int](1, 2, 3, 5)
	result := a.Equal(b)
